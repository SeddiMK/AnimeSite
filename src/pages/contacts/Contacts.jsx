      ...
      <div className="contacts__description">
        <div className="contacts__desc-block desc-block">
          ...
          <p>
            ...
            комментарии ниже, валидация email, валидация комментария (нельзя
            написать один и тот же комментарий дважды). Кнопка "Добавить в
            список" добавляет в redux уникальные id anime.
            <br />
            ...
            <br />
            Страница регистрации. Вход и регистрация через социальные сети пока
            не реализованно. При переходе на стр регистрации фокус на вводе
            Email.
            <br />
            Личный кабинет: загрузить, удалить аватар (Firebase.storage),
            изменить ник.
          </p>
        </div>
